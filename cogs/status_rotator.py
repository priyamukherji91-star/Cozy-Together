...
# Editable from the staff panel; the defaults below are what he says until
# somebody changes them, and Reset puts them back.
STATUS_LINES: tuple[str, ...] = lines.register(
    "status",
    "Discord statuses",
    (
        "Meow..Meow fuck off",
    ...
    where="his presence, rotating every few minutes",
)
